...
int Xapian::InternalStemDutch::r_prelude() { /* forwardmode */
    ...
    {   int c3 = c; /* try, line 57 */
        bra = c; /* [, line 57 */
        if (!(eq_s(1, s_5))) { c = c3; goto lab1; } /* literal, line 57 */
        ket = c; /* ], line 57 */
    ...
    while(1) { /* repeat, line 58 */
        ...
        while(1) { /* goto, line 58 */
            ...
            bra = c; /* [, line 59 */
            {   int c6 = c; /* or, line 59 */
                if (!(eq_s(1, s_7))) goto lab5; /* literal, line 59 */
                ket = c; /* ], line 59 */
                if (in_grouping_U(g_v, 97, 232, 0)) goto lab5; /* grouping v, line 59 */
                {   int ret = slice_from_s(1, s_8); /* <-, line 59 */
                    if (ret < 0) return ret;
                }
                goto lab4;
            lab5:
                c = c6;
                if (!(eq_s(1, s_9))) goto lab3; /* literal, line 60 */
                ket = c; /* ], line 60 */
                {   int ret = slice_from_s(1, s_10); /* <-, line 60 */
                    if (ret < 0) return ret;
                }
            }
        lab4:
...
int Xapian::InternalStemDutch::r_e_ending() { /* backwardmode */
    ...
    ket = c; /* [, line 96 */
    if (!(eq_s_b(1, s_13))) return 0; /* literal, line 96 */
    bra = c; /* ], line 96 */
...
int Xapian::InternalStemDutch::r_en_ending() { /* backwardmode */
    ...
    {   int m1 = l - c; (void)m1; /* and, line 102 */
        ...
        {   int m2 = l - c; (void)m2; /* not, line 102 */
            if (!(eq_s_b(3, s_14))) goto lab0; /* literal, line 102 */
            return 0;
        lab0:
            c = l - m2;
        }
...
int Xapian::InternalStemDutch::r_standard_suffix() { /* backwardmode */
    ...
    {   int m1 = l - c; (void)m1; /* do, line 107 */
        ...
        switch(among_var) { /* among, line 108 */
            ...
            case 1:
                ...
                {   int ret = slice_from_s(4, s_15); /* <-, line 110 */
                    if (ret < 0) return ret;
                }
                break;
            case 2:
    ...
    {   int m3 = l - c; (void)m3; /* do, line 122 */
        ket = c; /* [, line 122 */
        if (!(eq_s_b(4, s_16))) goto lab2; /* literal, line 122 */
        bra = c; /* ], line 122 */
        ...
        {   int m4 = l - c; (void)m4; /* not, line 122 */
            if (!(eq_s_b(1, s_17))) goto lab3; /* literal, line 122 */
            goto lab2;
        lab3:
            c = l - m4;
        }
        ...
        ket = c; /* [, line 123 */
        if (!(eq_s_b(2, s_18))) goto lab2; /* literal, line 123 */
        bra = c; /* ], line 123 */
        ...
        switch(among_var) { /* among, line 127 */
            ...
            case 1:
                ...
                {   int m6 = l - c; (void)m6; /* or, line 130 */
                    ket = c; /* [, line 130 */
                    if (!(eq_s_b(2, s_19))) goto lab6; /* literal, line 130 */
                    bra = c; /* ], line 130 */
                    ...
                    {   int m7 = l - c; (void)m7; /* not, line 130 */
                        if (!(eq_s_b(1, s_20))) goto lab7; /* literal, line 130 */
                        goto lab6;
                    lab7:
                        c = l - m7;
                    }
            ...
            case 2:
                ...
                {   int m8 = l - c; (void)m8; /* not, line 133 */
                    if (!(eq_s_b(1, s_21))) goto lab8; /* literal, line 133 */
                    goto lab4;
                lab8:
                    c = l - m8;
                }
