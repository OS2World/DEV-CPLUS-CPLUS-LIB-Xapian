...
int Xapian::InternalStemItalian::r_prelude() { /* forwardmode */
    ...
    while(1) { /* repeat, line 46 */
        ...
        while(1) { /* goto, line 46 */
            ...
            bra = c; /* [, line 47 */
            {   int c5 = c; /* or, line 47 */
                if (!(eq_s(1, s_6))) goto lab4; /* literal, line 47 */
                ket = c; /* ], line 47 */
                if (in_grouping_U(g_v, 97, 249, 0)) goto lab4; /* grouping v, line 47 */
                {   int ret = slice_from_s(1, s_7); /* <-, line 47 */
                    if (ret < 0) return ret;
                }
                goto lab3;
            lab4:
                c = c5;
                if (!(eq_s(1, s_8))) goto lab2; /* literal, line 48 */
                ket = c; /* ], line 48 */
                if (in_grouping_U(g_v, 97, 249, 0)) goto lab2; /* grouping v, line 48 */
                {   int ret = slice_from_s(1, s_9); /* <-, line 48 */
                    if (ret < 0) return ret;
                }
            }
        lab3:
    ...
    while(1) { /* repeat, line 70 */
        ...
        switch(among_var) { /* among, line 72 */
            ...
            case 1:
                ...
                break;
            case 2:
                {   int ret = slice_from_s(1, s_11); /* <-, line 74 */
                    if (ret < 0) return ret;
                }
                break;
            case 3:
...
int Xapian::InternalStemItalian::r_attached_pronoun() { /* backwardmode */
    ...
    switch(among_var) { /* among, line 97 */
        ...
        case 1:
            ...
            break;
        case 2:
            {   int ret = slice_from_s(1, s_12); /* <-, line 99 */
                if (ret < 0) return ret;
            }
            break;
    }
    ...
    switch(among_var) { /* among, line 104 */
        ...
        case 2:
            ...
            {   int m1 = l - c; (void)m1; /* try, line 114 */
                ket = c; /* [, line 114 */
                if (!(eq_s_b(2, s_13))) { c = l - m1; goto lab0; } /* literal, line 114 */
                bra = c; /* ], line 114 */
        ...
        case 3:
            ...
            {   int ret = slice_from_s(3, s_14); /* <-, line 117 */
                if (ret < 0) return ret;
            }
            break;
        case 4:
            ...
            {   int ret = slice_from_s(1, s_15); /* <-, line 119 */
                if (ret < 0) return ret;
            }
            break;
        case 5:
            ...
            {   int ret = slice_from_s(4, s_16); /* <-, line 121 */
                if (ret < 0) return ret;
            }
            break;
        case 6:
        ...
        case 7:
            ...
            {   int m2 = l - c; (void)m2; /* try, line 126 */
                ...
                switch(among_var) { /* among, line 127 */
                    ...
                    case 1:
                        ket = c; /* [, line 128 */
                        if (!(eq_s_b(2, s_17))) { c = l - m2; goto lab1; } /* literal, line 128 */
                        bra = c; /* ], line 128 */
        ...
        case 9:
            ...
            {   int m4 = l - c; (void)m4; /* try, line 143 */
                ket = c; /* [, line 143 */
                if (!(eq_s_b(2, s_18))) { c = l - m4; goto lab3; } /* literal, line 143 */
                bra = c; /* ], line 143 */
                ...
                ket = c; /* [, line 143 */
                if (!(eq_s_b(2, s_19))) { c = l - m4; goto lab3; } /* literal, line 143 */
                bra = c; /* ], line 143 */
                {   int ret = r_R2(); /* call R2, line 143 */
                    if (ret == 0) { c = l - m4; goto lab3; }
                    if (ret < 0) return ret;
...
int Xapian::InternalStemItalian::r_vowel_suffix() { /* backwardmode */
    {   int m1 = l - c; (void)m1; /* try, line 171 */
        ...
        ket = c; /* [, line 173 */
        if (!(eq_s_b(1, s_20))) { c = l - m1; goto lab0; } /* literal, line 173 */
        bra = c; /* ], line 173 */
    ...
    {   int m2 = l - c; (void)m2; /* try, line 175 */
        ket = c; /* [, line 176 */
        if (!(eq_s_b(1, s_21))) { c = l - m2; goto lab1; } /* literal, line 176 */
        bra = c; /* ], line 176 */
