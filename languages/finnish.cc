    ...
    switch(among_var) { /* among, line 70 */
        ...
        case 1:
            {   int m2 = l - c; (void)m2; /* not, line 72 */
                if (!(eq_s_b(1, s_0))) goto lab0; /* literal, line 72 */
                return 0;
            lab0:
                c = l - m2;
            }
        ...
        case 2:
            ...
            ket = c; /* [, line 74 */
            if (!(eq_s_b(3, s_1))) return 0; /* literal, line 74 */
            bra = c; /* ], line 74 */
            {   int ret = slice_from_s(3, s_2); /* <-, line 74 */
                if (ret < 0) return ret;
            }
            break;
        case 3:
...
int Xapian::InternalStemFinnish::r_VI() { /* backwardmode */
    if (!(eq_s_b(1, s_3))) return 0; /* literal, line 93 */
...
int Xapian::InternalStemFinnish::r_case_ending() { /* backwardmode */
    ...
    switch(among_var) { /* among, line 97 */
        case 0: return 0;
        case 1:
            if (!(eq_s_b(1, s_4))) return 0; /* literal, line 98 */
            break;
        case 2:
            if (!(eq_s_b(1, s_5))) return 0; /* literal, line 99 */
            break;
        case 3:
            if (!(eq_s_b(1, s_6))) return 0; /* literal, line 100 */
            break;
        case 4:
            if (!(eq_s_b(1, s_7))) return 0; /* literal, line 101 */
            break;
        case 5:
            if (!(eq_s_b(2, s_8))) return 0; /* literal, line 102 */
            break;
        case 6:
            if (!(eq_s_b(2, s_9))) return 0; /* literal, line 103 */
            break;
        case 7:
            {   int m2 = l - c; (void)m2; /* try, line 111 */
                {   int m3 = l - c; (void)m3; /* and, line 113 */
                    ...
                    lab2:
                        c = l - m4;
                        if (!(eq_s_b(2, s_10))) { c = l - m2; goto lab0; } /* literal, line 112 */
                    }
                lab1:
                    c = l - m3;
        ...
        case 8:
            ...
            break;
        case 9:
            if (!(eq_s_b(1, s_11))) return 0; /* literal, line 121 */
            break;
    }
    ...
    switch(among_var) { /* among, line 143 */
        ...
        case 1:
            {   int m2 = l - c; (void)m2; /* not, line 146 */
                if (!(eq_s_b(2, s_12))) goto lab0; /* literal, line 146 */
                return 0;
            lab0:
                c = l - m2;
            }
...
int Xapian::InternalStemFinnish::r_t_plural() { /* backwardmode */
    ...
    {   int m1 = l - c; (void)m1; /* setlimit, line 161 */
        ...
        c = l - m1;
        ket = c; /* [, line 162 */
        if (!(eq_s_b(1, s_13))) { lb = mlimit1; return 0; } /* literal, line 162 */
        bra = c; /* ], line 162 */
    ...
    switch(among_var) { /* among, line 166 */
        ...
        case 1:
            {   int m4 = l - c; (void)m4; /* not, line 167 */
                if (!(eq_s_b(2, s_14))) goto lab0; /* literal, line 167 */
                return 0;
            lab0:
                c = l - m4;
            }
...
int Xapian::InternalStemFinnish::r_tidy() { /* backwardmode */
    {   int m1 = l - c; (void)m1; /* setlimit, line 173 */
        ...
        {   int m5 = l - c; (void)m5; /* do, line 176 */
            ket = c; /* [, line 176 */
            if (!(eq_s_b(1, s_15))) goto lab2; /* literal, line 176 */
            bra = c; /* ], line 176 */
            {   int m6 = l - c; (void)m6; /* or, line 176 */
                if (!(eq_s_b(1, s_16))) goto lab4; /* literal, line 176 */
                goto lab3;
            lab4:
                c = l - m6;
                if (!(eq_s_b(1, s_17))) goto lab2; /* literal, line 176 */
            }
        lab3:
        ...
        {   int m7 = l - c; (void)m7; /* do, line 177 */
            ket = c; /* [, line 177 */
            if (!(eq_s_b(1, s_18))) goto lab5; /* literal, line 177 */
            bra = c; /* ], line 177 */
            if (!(eq_s_b(1, s_19))) goto lab5; /* literal, line 177 */
