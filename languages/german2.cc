...
int Xapian::InternalStemGerman2::r_prelude() { /* forwardmode */
    ...
    {   int c_test1 = c; /* test, line 30 */
        while(1) { /* repeat, line 30 */
            ...
            while(1) { /* goto, line 30 */
                ...
                bra = c; /* [, line 31 */
                {   int c4 = c; /* or, line 31 */
                    if (!(eq_s(1, s_0))) goto lab3; /* literal, line 31 */
                    ket = c; /* ], line 31 */
                ...
                lab3:
                    c = c4;
                    if (!(eq_s(1, s_2))) goto lab1; /* literal, line 32 */
                    ket = c; /* ], line 32 */
                    if (in_grouping_U(g_v, 97, 252, 0)) goto lab1; /* grouping v, line 32 */
                    {   int ret = slice_from_s(1, s_3); /* <-, line 32 */
                        if (ret < 0) return ret;
                    }
                }
            lab2:
    ...
    while(1) { /* repeat, line 35 */
        ...
        switch(among_var) { /* among, line 36 */
            case 0: goto lab4;
            case 1:
                {   int ret = slice_from_s(2, s_4); /* <-, line 37 */
                    if (ret < 0) return ret;
                }
                break;
            case 2:
                {   int ret = slice_from_s(2, s_5); /* <-, line 38 */
                    if (ret < 0) return ret;
                }
                break;
            case 3:
                {   int ret = slice_from_s(2, s_6); /* <-, line 39 */
                    if (ret < 0) return ret;
                }
                break;
            case 4:
                {   int ret = slice_from_s(2, s_7); /* <-, line 40 */
                    if (ret < 0) return ret;
                }
                break;
            case 5:
...
int Xapian::InternalStemGerman2::r_postlude() { /* forwardmode */
    ...
    while(1) { /* repeat, line 61 */
        ...
        switch(among_var) { /* among, line 63 */
            case 0: goto lab0;
            case 1:
                {   int ret = slice_from_s(1, s_8); /* <-, line 64 */
                    if (ret < 0) return ret;
                }
                break;
            case 2:
                {   int ret = slice_from_s(1, s_9); /* <-, line 65 */
                    if (ret < 0) return ret;
                }
                break;
            case 3:
                {   int ret = slice_from_s(1, s_10); /* <-, line 66 */
                    if (ret < 0) return ret;
                }
                break;
            case 4:
                {   int ret = slice_from_s(1, s_11); /* <-, line 67 */
                    if (ret < 0) return ret;
                }
                break;
            case 5:
                {   int ret = slice_from_s(1, s_12); /* <-, line 68 */
                    if (ret < 0) return ret;
                }
                break;
            case 6:
        ...
        switch(among_var) { /* among, line 101 */
            ...
            case 1:
                ...
                {   int m4 = l - c; (void)m4; /* try, line 104 */
                    ket = c; /* [, line 104 */
                    if (!(eq_s_b(2, s_13))) { c = l - m4; goto lab3; } /* literal, line 104 */
                    bra = c; /* ], line 104 */
                    {   int m5 = l - c; (void)m5; /* not, line 104 */
                        if (!(eq_s_b(1, s_14))) goto lab4; /* literal, line 104 */
                        { c = l - m4; goto lab3; }
                    lab4:
                        c = l - m5;
                    }
            ...
            case 2:
                {   int m6 = l - c; (void)m6; /* not, line 107 */
                    if (!(eq_s_b(1, s_15))) goto lab5; /* literal, line 107 */
                    goto lab2;
                lab5:
                    c = l - m6;
                }
            ...
            case 3:
                ...
                {   int m7 = l - c; (void)m7; /* try, line 111 */
                    ...
                    {   int m8 = l - c; (void)m8; /* or, line 112 */
                        if (!(eq_s_b(2, s_16))) goto lab8; /* literal, line 112 */
                        goto lab7;
                    lab8:
                        c = l - m8;
                        if (!(eq_s_b(2, s_17))) { c = l - m7; goto lab6; } /* literal, line 112 */
                    }
                lab7:
                    bra = c; /* ], line 112 */
