...
int Xapian::InternalStemEnglish::r_prelude() { /* forwardmode */
    ...
    {   int c1 = c; /* do, line 27 */
        bra = c; /* [, line 27 */
        if (!(eq_s(1, s_0))) goto lab0; /* literal, line 27 */
        ket = c; /* ], line 27 */
    ...
    {   int c2 = c; /* do, line 28 */
        bra = c; /* [, line 28 */
        if (!(eq_s(1, s_1))) goto lab1; /* literal, line 28 */
        ket = c; /* ], line 28 */
        {   int ret = slice_from_s(1, s_2); /* <-, line 28 */
            if (ret < 0) return ret;
        }
    ...
    {   int c3 = c; /* do, line 29 */
        while(1) { /* repeat, line 29 */
            ...
            while(1) { /* goto, line 29 */
                ...
                bra = c; /* [, line 29 */
                if (!(eq_s(1, s_3))) goto lab4; /* literal, line 29 */
                ket = c; /* ], line 29 */
                c = c5;
                break;
            lab4:
            ...
            {   int ret = slice_from_s(1, s_4); /* <-, line 29 */
                if (ret < 0) return ret;
            }
...
int Xapian::InternalStemEnglish::r_Step_1a() { /* backwardmode */
    ...
    switch(among_var) { /* among, line 65 */
        case 0: return 0;
        case 1:
            {   int ret = slice_from_s(2, s_5); /* <-, line 66 */
                if (ret < 0) return ret;
            }
            break;
        case 2:
            {   int m2 = l - c; (void)m2; /* or, line 68 */
                ...
                {   int ret = slice_from_s(1, s_6); /* <-, line 68 */
                    if (ret < 0) return ret;
                }
                goto lab1;
            lab2:
                c = l - m2;
                {   int ret = slice_from_s(2, s_7); /* <-, line 68 */
                    if (ret < 0) return ret;
                }
            }
        lab1:
...
int Xapian::InternalStemEnglish::r_Step_1b() { /* backwardmode */
    ...
    switch(among_var) { /* among, line 75 */
        ...
        case 1:
            ...
            {   int ret = slice_from_s(2, s_8); /* <-, line 77 */
                if (ret < 0) return ret;
            }
            break;
        case 2:
...
int Xapian::InternalStemEnglish::r_Step_1c() { /* backwardmode */
    ...
    {   int m1 = l - c; (void)m1; /* or, line 94 */
        if (!(eq_s_b(1, s_11))) goto lab1; /* literal, line 94 */
        goto lab0;
    lab1:
        c = l - m1;
        if (!(eq_s_b(1, s_12))) return 0; /* literal, line 94 */
    }
lab0:
    bra = c; /* ], line 94 */
    ...
    {   int ret = slice_from_s(1, s_13); /* <-, line 96 */
        if (ret < 0) return ret;
    }
    return 1;
}
...
int Xapian::InternalStemEnglish::r_Step_2() { /* backwardmode */
    ...
    switch(among_var) { /* among, line 100 */
        case 0: return 0;
        case 1:
            {   int ret = slice_from_s(4, s_14); /* <-, line 101 */
                if (ret < 0) return ret;
            }
            break;
        case 2:
            {   int ret = slice_from_s(4, s_15); /* <-, line 102 */
                if (ret < 0) return ret;
            }
            break;
        case 3:
            {   int ret = slice_from_s(4, s_16); /* <-, line 103 */
                if (ret < 0) return ret;
            }
            break;
        case 4:
            {   int ret = slice_from_s(4, s_17); /* <-, line 104 */
                if (ret < 0) return ret;
            }
            break;
        case 5:
            {   int ret = slice_from_s(3, s_18); /* <-, line 105 */
                if (ret < 0) return ret;
            }
            break;
        case 6:
            {   int ret = slice_from_s(3, s_19); /* <-, line 107 */
                if (ret < 0) return ret;
            }
            break;
        case 7:
            {   int ret = slice_from_s(3, s_20); /* <-, line 109 */
                if (ret < 0) return ret;
            }
            break;
        case 8:
            {   int ret = slice_from_s(2, s_21); /* <-, line 111 */
                if (ret < 0) return ret;
            }
            break;
        case 9:
            {   int ret = slice_from_s(3, s_22); /* <-, line 112 */
                if (ret < 0) return ret;
            }
            break;
        case 10:
            {   int ret = slice_from_s(3, s_23); /* <-, line 114 */
                if (ret < 0) return ret;
            }
            break;
        case 11:
            {   int ret = slice_from_s(3, s_24); /* <-, line 116 */
                if (ret < 0) return ret;
            }
            break;
        case 12:
            {   int ret = slice_from_s(3, s_25); /* <-, line 118 */
                if (ret < 0) return ret;
            }
            break;
        case 13:
            if (!(eq_s_b(1, s_26))) return 0; /* literal, line 119 */
            {   int ret = slice_from_s(2, s_27); /* <-, line 119 */
                if (ret < 0) return ret;
            }
            break;
        case 14:
            {   int ret = slice_from_s(3, s_28); /* <-, line 120 */
                if (ret < 0) return ret;
            }
            break;
        case 15:
            {   int ret = slice_from_s(4, s_29); /* <-, line 121 */
                if (ret < 0) return ret;
            }
            break;
        case 16:
...
int Xapian::InternalStemEnglish::r_Step_3() { /* backwardmode */
    ...
    switch(among_var) { /* among, line 127 */
        case 0: return 0;
        case 1:
            {   int ret = slice_from_s(4, s_30); /* <-, line 128 */
                if (ret < 0) return ret;
            }
            break;
        case 2:
            {   int ret = slice_from_s(3, s_31); /* <-, line 129 */
                if (ret < 0) return ret;
            }
            break;
        case 3:
            {   int ret = slice_from_s(2, s_32); /* <-, line 130 */
                if (ret < 0) return ret;
            }
            break;
        case 4:
            {   int ret = slice_from_s(2, s_33); /* <-, line 132 */
                if (ret < 0) return ret;
            }
            break;
        case 5:
    ...
    switch(among_var) { /* among, line 141 */
        ...
        case 2:
            {   int m1 = l - c; (void)m1; /* or, line 145 */
                if (!(eq_s_b(1, s_34))) goto lab1; /* literal, line 145 */
                goto lab0;
            lab1:
                c = l - m1;
                if (!(eq_s_b(1, s_35))) return 0; /* literal, line 145 */
            }
        lab0:
...
int Xapian::InternalStemEnglish::r_Step_5() { /* backwardmode */
    ...
    switch(among_var) { /* among, line 150 */
        ...
        case 2:
            ...
            if (!(eq_s_b(1, s_36))) return 0; /* literal, line 152 */
...
int Xapian::InternalStemEnglish::r_exception1() { /* forwardmode */
    ...
    switch(among_var) { /* among, line 170 */
        case 0: return 0;
        case 1:
            {   int ret = slice_from_s(3, s_37); /* <-, line 174 */
                if (ret < 0) return ret;
            }
            break;
        case 2:
            {   int ret = slice_from_s(3, s_38); /* <-, line 175 */
                if (ret < 0) return ret;
            }
            break;
        case 3:
            {   int ret = slice_from_s(3, s_39); /* <-, line 176 */
                if (ret < 0) return ret;
            }
            break;
        case 4:
            {   int ret = slice_from_s(3, s_40); /* <-, line 177 */
                if (ret < 0) return ret;
            }
            break;
        case 5:
            {   int ret = slice_from_s(3, s_41); /* <-, line 178 */
                if (ret < 0) return ret;
            }
            break;
        case 6:
            {   int ret = slice_from_s(3, s_42); /* <-, line 182 */
                if (ret < 0) return ret;
            }
            break;
        case 7:
            {   int ret = slice_from_s(5, s_43); /* <-, line 183 */
                if (ret < 0) return ret;
            }
            break;
        case 8:
            {   int ret = slice_from_s(4, s_44); /* <-, line 184 */
                if (ret < 0) return ret;
            }
            break;
        case 9:
            {   int ret = slice_from_s(5, s_45); /* <-, line 185 */
                if (ret < 0) return ret;
            }
            break;
        case 10:
            {   int ret = slice_from_s(4, s_46); /* <-, line 186 */
                if (ret < 0) return ret;
            }
            break;
        case 11:
            {   int ret = slice_from_s(5, s_47); /* <-, line 187 */
                if (ret < 0) return ret;
            }
            break;
    }
...
int Xapian::InternalStemEnglish::r_postlude() { /* forwardmode */
    ...
    while(1) { /* repeat, line 203 */
        ...
        while(1) { /* goto, line 203 */
            int c2 = c;
            bra = c; /* [, line 203 */
            if (!(eq_s(1, s_48))) goto lab1; /* literal, line 203 */
            ket = c; /* ], line 203 */
            c = c2;
            break;
        lab1:
        ...
        {   int ret = slice_from_s(1, s_49); /* <-, line 203 */
            if (ret < 0) return ret;
        }
        continue;
    lab0:
