...
int Xapian::InternalStemGerman::r_prelude() { /* forwardmode */
    ...
    while(1) { /* repeat, line 36 */
        ...
        while(1) { /* goto, line 36 */
            ...
            bra = c; /* [, line 37 */
            {   int c6 = c; /* or, line 37 */
                if (!(eq_s(1, s_2))) goto lab6; /* literal, line 37 */
                ket = c; /* ], line 37 */
                if (in_grouping_U(g_v, 97, 252, 0)) goto lab6; /* grouping v, line 37 */
                {   int ret = slice_from_s(1, s_3); /* <-, line 37 */
                    if (ret < 0) return ret;
                }
                goto lab5;
            lab6:
                c = c6;
                if (!(eq_s(1, s_4))) goto lab4; /* literal, line 38 */
                ket = c; /* ], line 38 */
                if (in_grouping_U(g_v, 97, 252, 0)) goto lab4; /* grouping v, line 38 */
                {   int ret = slice_from_s(1, s_5); /* <-, line 38 */
                    if (ret < 0) return ret;
                }
            }
        lab5:
...
int Xapian::InternalStemGerman::r_postlude() { /* forwardmode */
    ...
    while(1) { /* repeat, line 55 */
        ...
        switch(among_var) { /* among, line 57 */
            case 0: goto lab0;
            case 1:
                {   int ret = slice_from_s(1, s_6); /* <-, line 58 */
                    if (ret < 0) return ret;
                }
                break;
            case 2:
                {   int ret = slice_from_s(1, s_7); /* <-, line 59 */
                    if (ret < 0) return ret;
                }
                break;
            case 3:
                {   int ret = slice_from_s(1, s_8); /* <-, line 60 */
                    if (ret < 0) return ret;
                }
                break;
            case 4:
                {   int ret = slice_from_s(1, s_9); /* <-, line 61 */
                    if (ret < 0) return ret;
                }
                break;
            case 5:
                {   int ret = slice_from_s(1, s_10); /* <-, line 62 */
                    if (ret < 0) return ret;
                }
                break;
            case 6:
        ...
        switch(among_var) { /* among, line 95 */
            ...
            case 1:
                ...
                {   int m4 = l - c; (void)m4; /* try, line 98 */
                    ket = c; /* [, line 98 */
                    if (!(eq_s_b(2, s_11))) { c = l - m4; goto lab3; } /* literal, line 98 */
                    bra = c; /* ], line 98 */
                    {   int m5 = l - c; (void)m5; /* not, line 98 */
                        if (!(eq_s_b(1, s_12))) goto lab4; /* literal, line 98 */
                        { c = l - m4; goto lab3; }
                    lab4:
                        c = l - m5;
                    }
            ...
            case 2:
                {   int m6 = l - c; (void)m6; /* not, line 101 */
                    if (!(eq_s_b(1, s_13))) goto lab5; /* literal, line 101 */
                    goto lab2;
                lab5:
                    c = l - m6;
                }
            ...
            case 3:
                ...
                {   int m7 = l - c; (void)m7; /* try, line 105 */
                    ...
                    {   int m8 = l - c; (void)m8; /* or, line 106 */
                        if (!(eq_s_b(2, s_14))) goto lab8; /* literal, line 106 */
                        goto lab7;
                    lab8:
                        c = l - m8;
                        if (!(eq_s_b(2, s_15))) { c = l - m7; goto lab6; } /* literal, line 106 */
                    }
                lab7:
                    bra = c; /* ], line 106 */
