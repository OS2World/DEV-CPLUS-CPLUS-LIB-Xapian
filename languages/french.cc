    ...
    while(1) { /* repeat, line 38 */
        ...
        while(1) { /* goto, line 38 */
            ...
            {   int c3 = c; /* or, line 44 */
                ...
                bra = c; /* [, line 40 */
                {   int c4 = c; /* or, line 40 */
                    if (!(eq_s(1, s_0))) goto lab5; /* literal, line 40 */
                    ket = c; /* ], line 40 */
                    if (in_grouping_U(g_v, 97, 251, 0)) goto lab5; /* grouping v, line 40 */
                    {   int ret = slice_from_s(1, s_1); /* <-, line 40 */
                        if (ret < 0) return ret;
                    }
                    goto lab4;
                lab5:
                    c = c4;
                    if (!(eq_s(1, s_2))) goto lab6; /* literal, line 41 */
                    ket = c; /* ], line 41 */
                    if (in_grouping_U(g_v, 97, 251, 0)) goto lab6; /* grouping v, line 41 */
                    {   int ret = slice_from_s(1, s_3); /* <-, line 41 */
                        if (ret < 0) return ret;
                    }
                    goto lab4;
                lab6:
                    c = c4;
                    if (!(eq_s(1, s_4))) goto lab3; /* literal, line 42 */
                    ket = c; /* ], line 42 */
                    {   int ret = slice_from_s(1, s_5); /* <-, line 42 */
                        if (ret < 0) return ret;
                    }
                }
            lab4:
            ...
            lab3:
                c = c3;
                bra = c; /* [, line 45 */
                if (!(eq_s(1, s_6))) goto lab7; /* literal, line 45 */
                ket = c; /* ], line 45 */
                if (in_grouping_U(g_v, 97, 251, 0)) goto lab7; /* grouping v, line 45 */
                {   int ret = slice_from_s(1, s_7); /* <-, line 45 */
                    if (ret < 0) return ret;
                }
                goto lab2;
            lab7:
                c = c3;
                if (!(eq_s(1, s_8))) goto lab1; /* literal, line 47 */
                bra = c; /* [, line 47 */
                if (!(eq_s(1, s_9))) goto lab1; /* literal, line 47 */
                ket = c; /* ], line 47 */
                {   int ret = slice_from_s(1, s_10); /* <-, line 47 */
                    if (ret < 0) return ret;
                }
            }
        lab2:
...
int Xapian::InternalStemFrench::r_postlude() { /* forwardmode */
    ...
    while(1) { /* repeat, line 75 */
        ...
        switch(among_var) { /* among, line 77 */
            case 0: goto lab0;
            case 1:
                {   int ret = slice_from_s(1, s_11); /* <-, line 78 */
                    if (ret < 0) return ret;
                }
                break;
            case 2:
                {   int ret = slice_from_s(1, s_12); /* <-, line 79 */
                    if (ret < 0) return ret;
                }
                break;
            case 3:
                {   int ret = slice_from_s(1, s_13); /* <-, line 80 */
                    if (ret < 0) return ret;
                }
                break;
            case 4:
    ...
    switch(among_var) { /* among, line 92 */
        ...
        case 2:
            ...
            {   int m1 = l - c; (void)m1; /* try, line 100 */
                ket = c; /* [, line 100 */
                if (!(eq_s_b(2, s_14))) { c = l - m1; goto lab0; } /* literal, line 100 */
                bra = c; /* ], line 100 */
                ...
                lab2:
                    c = l - m2;
                    {   int ret = slice_from_s(3, s_15); /* <-, line 100 */
                        if (ret < 0) return ret;
                    }
                }
            lab1:
        ...
        case 3:
            ...
            {   int ret = slice_from_s(3, s_16); /* <-, line 104 */
                if (ret < 0) return ret;
            }
            break;
        case 4:
            ...
            {   int ret = slice_from_s(1, s_17); /* <-, line 107 */
                if (ret < 0) return ret;
            }
            break;
        case 5:
            ...
            {   int ret = slice_from_s(3, s_18); /* <-, line 110 */
                if (ret < 0) return ret;
            }
            break;
        case 6:
            ...
            {   int m3 = l - c; (void)m3; /* try, line 115 */
                ...
                switch(among_var) { /* among, line 116 */
                    ...
                    case 1:
                        ...
                        ket = c; /* [, line 117 */
                        if (!(eq_s_b(2, s_19))) { c = l - m3; goto lab3; } /* literal, line 117 */
                        bra = c; /* ], line 117 */
                        {   int ret = r_R2(); /* call R2, line 117 */
                            if (ret == 0) { c = l - m3; goto lab3; }
                            if (ret < 0) return ret;
                    ...
                    case 4:
                        ...
                        {   int ret = slice_from_s(1, s_21); /* <-, line 122 */
                            if (ret < 0) return ret;
                        }
                        break;
                }
            ...
            {   int m5 = l - c; (void)m5; /* try, line 130 */
                ...
                switch(among_var) { /* among, line 131 */
                    ...
                    case 1:
                        ...
                        lab8:
                            c = l - m6;
                            {   int ret = slice_from_s(3, s_22); /* <-, line 132 */
                                if (ret < 0) return ret;
                            }
                        }
                    lab7:
                    ...
                    case 2:
                        ...
                        lab10:
                            c = l - m7;
                            {   int ret = slice_from_s(3, s_23); /* <-, line 133 */
                                if (ret < 0) return ret;
                            }
                        }
                    lab9:
        ...
        case 8:
            ...
            {   int m8 = l - c; (void)m8; /* try, line 142 */
                ket = c; /* [, line 142 */
                if (!(eq_s_b(2, s_24))) { c = l - m8; goto lab11; } /* literal, line 142 */
                bra = c; /* ], line 142 */
                ...
                ket = c; /* [, line 142 */
                if (!(eq_s_b(2, s_25))) { c = l - m8; goto lab11; } /* literal, line 142 */
                bra = c; /* ], line 142 */
                ...
                lab13:
                    c = l - m9;
                    {   int ret = slice_from_s(3, s_26); /* <-, line 142 */
                        if (ret < 0) return ret;
                    }
                }
            lab12:
            ...
            break;
        case 9:
            {   int ret = slice_from_s(3, s_27); /* <-, line 144 */
                if (ret < 0) return ret;
            }
            break;
        case 10:
            ...
            {   int ret = slice_from_s(2, s_28); /* <-, line 145 */
                if (ret < 0) return ret;
            }
            break;
        case 11:
            ...
            lab15:
                ...
                {   int ret = slice_from_s(3, s_29); /* <-, line 147 */
                    if (ret < 0) return ret;
                }
            }
        lab14:
        ...
        case 13:
            ...
            {   int ret = slice_from_s(3, s_30); /* <-, line 155 */
                if (ret < 0) return ret;
            }
        ...
        case 14:
            ...
            {   int ret = slice_from_s(3, s_31); /* <-, line 156 */
                if (ret < 0) return ret;
            }
        ...
        switch(among_var) { /* among, line 175 */
            ...
            case 3:
                ...
                {   int m2 = l - c; (void)m2; /* try, line 191 */
                    ket = c; /* [, line 191 */
                    if (!(eq_s_b(1, s_32))) { c = l - m2; goto lab0; } /* literal, line 191 */
                    bra = c; /* ], line 191 */
...
int Xapian::InternalStemFrench::r_residual_suffix() { /* backwardmode */
    ...
    {   int m1 = l - c; (void)m1; /* try, line 199 */
        ket = c; /* [, line 199 */
        if (!(eq_s_b(1, s_33))) { c = l - m1; goto lab0; } /* literal, line 199 */
        bra = c; /* ], line 199 */
        ...
        switch(among_var) { /* among, line 201 */
            ...
            case 1:
                ...
                {   int m4 = l - c; (void)m4; /* or, line 202 */
                    if (!(eq_s_b(1, s_34))) goto lab2; /* literal, line 202 */
                    goto lab1;
                lab2:
                    c = l - m4;
                    if (!(eq_s_b(1, s_35))) { lb = mlimit3; return 0; } /* literal, line 202 */
                }
            lab1:
                if (slice_del() == -1) return -1; /* delete, line 202 */
                break;
            case 2:
                {   int ret = slice_from_s(1, s_36); /* <-, line 204 */
                    if (ret < 0) return ret;
                }
                break;
            case 3:
                ...
                break;
            case 4:
                if (!(eq_s_b(2, s_37))) { lb = mlimit3; return 0; } /* literal, line 206 */
...
int Xapian::InternalStemFrench::r_un_accent() { /* backwardmode */
    ...
    {   int m1 = l - c; (void)m1; /* or, line 217 */
        if (!(eq_s_b(2, s_38))) goto lab2; /* literal, line 217 */
        goto lab1;
    lab2:
        c = l - m1;
        if (!(eq_s_b(2, s_39))) return 0; /* literal, line 217 */
    }
lab1:
    bra = c; /* ], line 217 */
    {   int ret = slice_from_s(1, s_40); /* <-, line 217 */
        if (ret < 0) return ret;
    }
    return 1;
}
            ...
            lab5:
                ...
                {   int m7 = l - c; (void)m7; /* try, line 234 */
                    ...
                    {   int m8 = l - c; (void)m8; /* or, line 234 */
                        if (!(eq_s_b(1, s_41))) goto lab10; /* literal, line 234 */
                        bra = c; /* ], line 234 */
                        {   int ret = slice_from_s(1, s_42); /* <-, line 234 */
                            if (ret < 0) return ret;
                        }
                        goto lab9;
                    lab10:
                        c = l - m8;
                        if (!(eq_s_b(2, s_43))) { c = l - m7; goto lab8; } /* literal, line 235 */
                        bra = c; /* ], line 235 */
                        {   int ret = slice_from_s(1, s_44); /* <-, line 235 */
                            if (ret < 0) return ret;
                        }
                    }
                lab9:
