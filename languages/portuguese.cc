...
int Xapian::InternalStemPortuguese::r_standard_suffix() { /* backwardmode */
    ...
    switch(among_var) { /* among, line 77 */
        ...
        case 9:
            ...
            if (!(eq_s_b(1, s_9))) return 0; /* literal, line 153 */
            {   int ret = slice_from_s(2, s_10); /* <-, line 154 */
                if (ret < 0) return ret;
            }
            break;
    }
    ...
    switch(among_var) { /* among, line 192 */
        ...
        case 1:
            ...
            {   int m1 = l - c; (void)m1; /* or, line 194 */
                if (!(eq_s_b(1, s_11))) goto lab1; /* literal, line 194 */
                bra = c; /* ], line 194 */
                {   int m_test2 = l - c; /* test, line 194 */
                    if (!(eq_s_b(1, s_12))) goto lab1; /* literal, line 194 */
                    c = l - m_test2;
                }
                goto lab0;
            lab1:
                c = l - m1;
                if (!(eq_s_b(1, s_13))) return 0; /* literal, line 195 */
                bra = c; /* ], line 195 */
                {   int m_test3 = l - c; /* test, line 195 */
                    if (!(eq_s_b(1, s_14))) return 0; /* literal, line 195 */
                    c = l - m_test3;
                }
            }
        lab0:
            ...
            break;
        case 2:
            {   int ret = slice_from_s(1, s_15); /* <-, line 196 */
                if (ret < 0) return ret;
            }
            break;
    }
        ...
        {   int m4 = l - c; (void)m4; /* or, line 209 */
            ...
            lab5:
                ...
                {   int m7 = l - c; (void)m7; /* do, line 207 */
                    ket = c; /* [, line 207 */
                    if (!(eq_s_b(1, s_16))) goto lab7; /* literal, line 207 */
                    bra = c; /* ], line 207 */
                    {   int m_test8 = l - c; /* test, line 207 */
                        if (!(eq_s_b(1, s_17))) goto lab7; /* literal, line 207 */
                        c = l - m_test8;
                    }
