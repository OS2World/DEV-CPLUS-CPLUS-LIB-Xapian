...
int Xapian::InternalStemLovins::r_E() { /* backwardmode */
    ...
    {   int m2 = l - c; (void)m2; /* not, line 25 */
        if (!(eq_s_b(1, s_0))) goto lab0; /* literal, line 25 */
        return 0;
    lab0:
        c = l - m2;
    }
...
int Xapian::InternalStemLovins::r_F() { /* backwardmode */
    ...
    {   int m2 = l - c; (void)m2; /* not, line 26 */
        if (!(eq_s_b(1, s_1))) goto lab0; /* literal, line 26 */
        return 0;
    lab0:
        c = l - m2;
    }
...
int Xapian::InternalStemLovins::r_G() { /* backwardmode */
    ...
    if (!(eq_s_b(1, s_2))) return 0; /* literal, line 27 */
    return 1;
}
...
int Xapian::InternalStemLovins::r_H() { /* backwardmode */
    ...
    {   int m2 = l - c; (void)m2; /* or, line 28 */
        if (!(eq_s_b(1, s_3))) goto lab1; /* literal, line 28 */
        goto lab0;
    lab1:
        c = l - m2;
        if (!(eq_s_b(2, s_4))) return 0; /* literal, line 28 */
    }
lab0:
    return 1;
}
...
int Xapian::InternalStemLovins::r_I() { /* backwardmode */
    ...
    {   int m2 = l - c; (void)m2; /* not, line 29 */
        if (!(eq_s_b(1, s_5))) goto lab0; /* literal, line 29 */
        return 0;
    lab0:
        c = l - m2;
    }
    {   int m3 = l - c; (void)m3; /* not, line 29 */
        if (!(eq_s_b(1, s_6))) goto lab1; /* literal, line 29 */
        return 0;
    lab1:
        c = l - m3;
    }
...
int Xapian::InternalStemLovins::r_J() { /* backwardmode */
    ...
    {   int m2 = l - c; (void)m2; /* not, line 30 */
        if (!(eq_s_b(1, s_7))) goto lab0; /* literal, line 30 */
        return 0;
    lab0:
        c = l - m2;
    }
    {   int m3 = l - c; (void)m3; /* not, line 30 */
        if (!(eq_s_b(1, s_8))) goto lab1; /* literal, line 30 */
        return 0;
    lab1:
        c = l - m3;
    }
...
int Xapian::InternalStemLovins::r_K() { /* backwardmode */
    ...
    {   int m2 = l - c; (void)m2; /* or, line 31 */
        if (!(eq_s_b(1, s_9))) goto lab1; /* literal, line 31 */
        goto lab0;
    lab1:
        c = l - m2;
        if (!(eq_s_b(1, s_10))) goto lab2; /* literal, line 31 */
        goto lab0;
    lab2:
        c = l - m2;
        if (!(eq_s_b(1, s_11))) return 0; /* literal, line 31 */
        {   int ret = skip_utf8(p, c, lb, 0, -1);
            if (ret < 0) return 0;
            c = ret; /* next, line 31 */
        }
        if (!(eq_s_b(1, s_12))) return 0; /* literal, line 31 */
    }
lab0:
    return 1;
}
...
int Xapian::InternalStemLovins::r_L() { /* backwardmode */
    ...
    {   int m2 = l - c; (void)m2; /* not, line 32 */
        if (!(eq_s_b(1, s_13))) goto lab0; /* literal, line 32 */
        return 0;
    lab0:
        c = l - m2;
    }
    {   int m3 = l - c; (void)m3; /* not, line 32 */
        if (!(eq_s_b(1, s_14))) goto lab1; /* literal, line 32 */
        return 0;
    lab1:
        c = l - m3;
    }
    {   int m4 = l - c; (void)m4; /* not, line 32 */
        if (!(eq_s_b(1, s_15))) goto lab2; /* literal, line 32 */
        {   int m5 = l - c; (void)m5; /* not, line 32 */
            if (!(eq_s_b(1, s_16))) goto lab3; /* literal, line 32 */
            goto lab2;
        lab3:
            c = l - m5;
        }
...
int Xapian::InternalStemLovins::r_M() { /* backwardmode */
    ...
    {   int m2 = l - c; (void)m2; /* not, line 33 */
        if (!(eq_s_b(1, s_17))) goto lab0; /* literal, line 33 */
        return 0;
    lab0:
        c = l - m2;
    }
    {   int m3 = l - c; (void)m3; /* not, line 33 */
        if (!(eq_s_b(1, s_18))) goto lab1; /* literal, line 33 */
        return 0;
    lab1:
        c = l - m3;
    }
    {   int m4 = l - c; (void)m4; /* not, line 33 */
        if (!(eq_s_b(1, s_19))) goto lab2; /* literal, line 33 */
        return 0;
    lab2:
        c = l - m4;
    }
    {   int m5 = l - c; (void)m5; /* not, line 33 */
        if (!(eq_s_b(1, s_20))) goto lab3; /* literal, line 33 */
        return 0;
    lab3:
        c = l - m5;
    }
...
int Xapian::InternalStemLovins::r_N() { /* backwardmode */
    ...
    {   int m2 = l - c; (void)m2; /* or, line 34 */
        {   int m3 = l - c; (void)m3; /* not, line 34 */
            if (!(eq_s_b(1, s_21))) goto lab2; /* literal, line 34 */
            goto lab1;
        lab2:
            c = l - m3;
        }
...
int Xapian::InternalStemLovins::r_O() { /* backwardmode */
    ...
    {   int m2 = l - c; (void)m2; /* or, line 35 */
        if (!(eq_s_b(1, s_22))) goto lab1; /* literal, line 35 */
        goto lab0;
    lab1:
        c = l - m2;
        if (!(eq_s_b(1, s_23))) return 0; /* literal, line 35 */
    }
lab0:
    return 1;
}
...
int Xapian::InternalStemLovins::r_P() { /* backwardmode */
    ...
    {   int m2 = l - c; (void)m2; /* not, line 36 */
        if (!(eq_s_b(1, s_24))) goto lab0; /* literal, line 36 */
        return 0;
    lab0:
        c = l - m2;
    }
...
int Xapian::InternalStemLovins::r_Q() { /* backwardmode */
    ...
    {   int m3 = l - c; (void)m3; /* not, line 37 */
        if (!(eq_s_b(1, s_25))) goto lab0; /* literal, line 37 */
        return 0;
    lab0:
        c = l - m3;
    }
    {   int m4 = l - c; (void)m4; /* not, line 37 */
        if (!(eq_s_b(1, s_26))) goto lab1; /* literal, line 37 */
        return 0;
    lab1:
        c = l - m4;
    }
...
int Xapian::InternalStemLovins::r_R() { /* backwardmode */
    ...
    {   int m2 = l - c; (void)m2; /* or, line 38 */
        if (!(eq_s_b(1, s_27))) goto lab1; /* literal, line 38 */
        goto lab0;
    lab1:
        c = l - m2;
        if (!(eq_s_b(1, s_28))) return 0; /* literal, line 38 */
    }
lab0:
    return 1;
}
...
int Xapian::InternalStemLovins::r_S() { /* backwardmode */
    ...
    {   int m2 = l - c; (void)m2; /* or, line 39 */
        if (!(eq_s_b(2, s_29))) goto lab1; /* literal, line 39 */
        goto lab0;
    lab1:
        c = l - m2;
        if (!(eq_s_b(1, s_30))) return 0; /* literal, line 39 */
        {   int m3 = l - c; (void)m3; /* not, line 39 */
            if (!(eq_s_b(1, s_31))) goto lab2; /* literal, line 39 */
            return 0;
        lab2:
            c = l - m3;
        }
...
int Xapian::InternalStemLovins::r_T() { /* backwardmode */
    ...
    {   int m2 = l - c; (void)m2; /* or, line 40 */
        if (!(eq_s_b(1, s_32))) goto lab1; /* literal, line 40 */
        goto lab0;
    lab1:
        c = l - m2;
        if (!(eq_s_b(1, s_33))) return 0; /* literal, line 40 */
        {   int m3 = l - c; (void)m3; /* not, line 40 */
            if (!(eq_s_b(1, s_34))) goto lab2; /* literal, line 40 */
            return 0;
        lab2:
            c = l - m3;
        }
...
int Xapian::InternalStemLovins::r_U() { /* backwardmode */
    ...
    {   int m2 = l - c; (void)m2; /* or, line 41 */
        if (!(eq_s_b(1, s_35))) goto lab1; /* literal, line 41 */
        goto lab0;
    lab1:
        c = l - m2;
        if (!(eq_s_b(1, s_36))) goto lab2; /* literal, line 41 */
        goto lab0;
    lab2:
        c = l - m2;
        if (!(eq_s_b(1, s_37))) goto lab3; /* literal, line 41 */
        goto lab0;
    lab3:
        c = l - m2;
        if (!(eq_s_b(1, s_38))) return 0; /* literal, line 41 */
    }
lab0:
    return 1;
}
...
int Xapian::InternalStemLovins::r_V() { /* backwardmode */
    ...
    if (!(eq_s_b(1, s_39))) return 0; /* literal, line 42 */
    return 1;
}
...
int Xapian::InternalStemLovins::r_W() { /* backwardmode */
    ...
    {   int m2 = l - c; (void)m2; /* not, line 43 */
        if (!(eq_s_b(1, s_40))) goto lab0; /* literal, line 43 */
        return 0;
    lab0:
        c = l - m2;
    }
    {   int m3 = l - c; (void)m3; /* not, line 43 */
        if (!(eq_s_b(1, s_41))) goto lab1; /* literal, line 43 */
        return 0;
    lab1:
        c = l - m3;
    }
...
int Xapian::InternalStemLovins::r_X() { /* backwardmode */
    ...
    {   int m2 = l - c; (void)m2; /* or, line 44 */
        if (!(eq_s_b(1, s_42))) goto lab1; /* literal, line 44 */
        goto lab0;
    lab1:
        c = l - m2;
        if (!(eq_s_b(1, s_43))) goto lab2; /* literal, line 44 */
        goto lab0;
    lab2:
        c = l - m2;
        if (!(eq_s_b(1, s_44))) return 0; /* literal, line 44 */
        {   int ret = skip_utf8(p, c, lb, 0, -1);
            if (ret < 0) return 0;
            c = ret; /* next, line 44 */
        }
        if (!(eq_s_b(1, s_45))) return 0; /* literal, line 44 */
    }
lab0:
    return 1;
}
...
int Xapian::InternalStemLovins::r_Y() { /* backwardmode */
    ...
    if (!(eq_s_b(2, s_46))) return 0; /* literal, line 45 */
    return 1;
}
...
int Xapian::InternalStemLovins::r_Z() { /* backwardmode */
    ...
    {   int m2 = l - c; (void)m2; /* not, line 46 */
        if (!(eq_s_b(1, s_47))) goto lab0; /* literal, line 46 */
        return 0;
    lab0:
        c = l - m2;
    }
...
int Xapian::InternalStemLovins::r_AA() { /* backwardmode */
    ...
    if (!(find_among_b(a_0, 9, 0, 0))) return 0;
    return 1;
}
...
int Xapian::InternalStemLovins::r_BB() { /* backwardmode */
    ...
    {   int m2 = l - c; (void)m2; /* not, line 49 */
        if (!(eq_s_b(3, s_48))) goto lab0; /* literal, line 49 */
        return 0;
    lab0:
        c = l - m2;
    }
    {   int m3 = l - c; (void)m3; /* not, line 49 */
        if (!(eq_s_b(4, s_49))) goto lab1; /* literal, line 49 */
        return 0;
    lab1:
        c = l - m3;
    }
...
int Xapian::InternalStemLovins::r_CC() { /* backwardmode */
    ...
    if (!(eq_s_b(1, s_50))) return 0; /* literal, line 50 */
    return 1;
}
...
int Xapian::InternalStemLovins::r_endings() { /* backwardmode */
    int among_var;
    ket = c; /* [, line 56 */
    among_var = find_among_b(a_1, 294, af_1, af); /* substring, line 56 */
...
int Xapian::InternalStemLovins::r_undouble() { /* backwardmode */
    {   int m_test1 = l - c; /* test, line 152 */
        ...
        if (!(find_among_b(a_2, 10, 0, 0))) return 0;
        c = l - m_test1;
    }
    ket = c; /* [, line 154 */
    {   int ret = skip_utf8(p, c, lb, 0, -1);
...
int Xapian::InternalStemLovins::r_respell() { /* backwardmode */
    ...
    among_var = find_among_b(a_3, 34, 0, 0);
    if (!(among_var)) return 0;
    bra = c; /* ], line 160 */
    switch(among_var) { /* among, line 160 */
        case 0: return 0;
        case 1:
            {   int ret = slice_from_s(3, s_51); /* <-, line 161 */
                if (ret < 0) return ret;
            }
            break;
        case 2:
            {   int ret = slice_from_s(2, s_52); /* <-, line 162 */
                if (ret < 0) return ret;
            }
            break;
        case 3:
            {   int ret = slice_from_s(2, s_53); /* <-, line 163 */
                if (ret < 0) return ret;
            }
            break;
        case 4:
            {   int ret = slice_from_s(2, s_54); /* <-, line 164 */
                if (ret < 0) return ret;
            }
            break;
        case 5:
            {   int ret = slice_from_s(2, s_55); /* <-, line 165 */
                if (ret < 0) return ret;
            }
            break;
        case 6:
            {   int ret = slice_from_s(5, s_56); /* <-, line 166 */
                if (ret < 0) return ret;
            }
            break;
        case 7:
            {   int ret = slice_from_s(5, s_57); /* <-, line 167 */
                if (ret < 0) return ret;
            }
            break;
        case 8:
            {   int ret = slice_from_s(4, s_58); /* <-, line 168 */
                if (ret < 0) return ret;
            }
            break;
        case 9:
            {   int m1 = l - c; (void)m1; /* not, line 169 */
                if (!(eq_s_b(1, s_59))) goto lab0; /* literal, line 169 */
                return 0;
            lab0:
                c = l - m1;
            }
            {   int m2 = l - c; (void)m2; /* not, line 169 */
                if (!(eq_s_b(1, s_60))) goto lab1; /* literal, line 169 */
                return 0;
            lab1:
                c = l - m2;
            }
            {   int m3 = l - c; (void)m3; /* not, line 169 */
                if (!(eq_s_b(1, s_61))) goto lab2; /* literal, line 169 */
                return 0;
            lab2:
                c = l - m3;
            }
            {   int ret = slice_from_s(1, s_62); /* <-, line 169 */
                if (ret < 0) return ret;
            }
            break;
        case 10:
            {   int ret = slice_from_s(3, s_63); /* <-, line 170 */
                if (ret < 0) return ret;
            }
            break;
        case 11:
            {   int ret = slice_from_s(3, s_64); /* <-, line 171 */
                if (ret < 0) return ret;
            }
            break;
        case 12:
            {   int ret = slice_from_s(3, s_65); /* <-, line 172 */
                if (ret < 0) return ret;
            }
            break;
        case 13:
            {   int ret = slice_from_s(3, s_66); /* <-, line 173 */
                if (ret < 0) return ret;
            }
            break;
        case 14:
            {   int ret = slice_from_s(2, s_67); /* <-, line 174 */
                if (ret < 0) return ret;
            }
            break;
        case 15:
            {   int ret = slice_from_s(2, s_68); /* <-, line 175 */
                if (ret < 0) return ret;
            }
            break;
        case 16:
            {   int ret = slice_from_s(2, s_69); /* <-, line 176 */
                if (ret < 0) return ret;
            }
            break;
        case 17:
            {   int ret = slice_from_s(3, s_70); /* <-, line 177 */
                if (ret < 0) return ret;
            }
            break;
        case 18:
            {   int ret = slice_from_s(3, s_71); /* <-, line 178 */
                if (ret < 0) return ret;
            }
            break;
        case 19:
            {   int ret = slice_from_s(3, s_72); /* <-, line 179 */
                if (ret < 0) return ret;
            }
            break;
        case 20:
            {   int ret = slice_from_s(3, s_73); /* <-, line 180 */
                if (ret < 0) return ret;
            }
            break;
        case 21:
            {   int ret = slice_from_s(3, s_74); /* <-, line 181 */
                if (ret < 0) return ret;
            }
            break;
        case 22:
            {   int ret = slice_from_s(4, s_75); /* <-, line 182 */
                if (ret < 0) return ret;
            }
            break;
        case 23:
            {   int ret = slice_from_s(4, s_76); /* <-, line 183 */
                if (ret < 0) return ret;
            }
            break;
        case 24:
            {   int m4 = l - c; (void)m4; /* not, line 184 */
                if (!(eq_s_b(1, s_77))) goto lab3; /* literal, line 184 */
                return 0;
            lab3:
                c = l - m4;
            }
            {   int ret = slice_from_s(3, s_78); /* <-, line 184 */
                if (ret < 0) return ret;
            }
            break;
        case 25:
            {   int ret = slice_from_s(3, s_79); /* <-, line 185 */
                if (ret < 0) return ret;
            }
            break;
        case 26:
            {   int ret = slice_from_s(3, s_80); /* <-, line 186 */
                if (ret < 0) return ret;
            }
            break;
        case 27:
            {   int ret = slice_from_s(3, s_81); /* <-, line 187 */
                if (ret < 0) return ret;
            }
            break;
        case 28:
            {   int m5 = l - c; (void)m5; /* not, line 188 */
                if (!(eq_s_b(1, s_82))) goto lab4; /* literal, line 188 */
                return 0;
            lab4:
                c = l - m5;
            }
            {   int m6 = l - c; (void)m6; /* not, line 188 */
                if (!(eq_s_b(1, s_83))) goto lab5; /* literal, line 188 */
                return 0;
            lab5:
                c = l - m6;
            }
            {   int ret = slice_from_s(3, s_84); /* <-, line 188 */
                if (ret < 0) return ret;
            }
            break;
        case 29:
            {   int ret = slice_from_s(3, s_85); /* <-, line 189 */
                if (ret < 0) return ret;
            }
            break;
        case 30:
            {   int m7 = l - c; (void)m7; /* not, line 190 */
                if (!(eq_s_b(1, s_86))) goto lab6; /* literal, line 190 */
                return 0;
            lab6:
                c = l - m7;
            }
            {   int ret = slice_from_s(3, s_87); /* <-, line 190 */
                if (ret < 0) return ret;
            }
            break;
        case 31:
            {   int ret = slice_from_s(3, s_88); /* <-, line 192 */
                if (ret < 0) return ret;
            }
            break;
        case 32:
            {   int m8 = l - c; (void)m8; /* not, line 193 */
                if (!(eq_s_b(1, s_89))) goto lab7; /* literal, line 193 */
                return 0;
            lab7:
                c = l - m8;
            }
            {   int ret = slice_from_s(2, s_90); /* <-, line 193 */
                if (ret < 0) return ret;
            }
            break;
        case 33:
            {   int ret = slice_from_s(2, s_91); /* <-, line 194 */
                if (ret < 0) return ret;
            }
            break;
        case 34:
            {   int ret = slice_from_s(2, s_92); /* <-, line 195 */
                if (ret < 0) return ret;
            }
            break;
    }
