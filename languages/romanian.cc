...
int Xapian::InternalStemRomanian::r_prelude() { /* forwardmode */
    while(1) { /* repeat, line 32 */
        ...
        while(1) { /* goto, line 32 */
            ...
            bra = c; /* [, line 33 */
            {   int c3 = c; /* or, line 33 */
                if (!(eq_s(1, s_0))) goto lab3; /* literal, line 33 */
                ket = c; /* ], line 33 */
                if (in_grouping_U(g_v, 97, 259, 0)) goto lab3; /* grouping v, line 33 */
                {   int ret = slice_from_s(1, s_1); /* <-, line 33 */
                    if (ret < 0) return ret;
                }
                goto lab2;
            lab3:
                c = c3;
                if (!(eq_s(1, s_2))) goto lab1; /* literal, line 34 */
                ket = c; /* ], line 34 */
                if (in_grouping_U(g_v, 97, 259, 0)) goto lab1; /* grouping v, line 34 */
                {   int ret = slice_from_s(1, s_3); /* <-, line 34 */
                    if (ret < 0) return ret;
                }
            }
        lab2:
...
int Xapian::InternalStemRomanian::r_step_0() { /* backwardmode */
    ...
    switch(among_var) { /* among, line 73 */
        ...
        case 1:
            ...
            break;
        case 2:
            {   int ret = slice_from_s(1, s_6); /* <-, line 77 */
                if (ret < 0) return ret;
            }
            break;
        case 3:
            {   int ret = slice_from_s(1, s_7); /* <-, line 79 */
                if (ret < 0) return ret;
            }
            break;
        case 4:
            {   int ret = slice_from_s(1, s_8); /* <-, line 81 */
                if (ret < 0) return ret;
            }
            break;
        case 5:
            {   int m1 = l - c; (void)m1; /* not, line 83 */
                if (!(eq_s_b(2, s_9))) goto lab0; /* literal, line 83 */
                return 0;
            lab0:
                c = l - m1;
            }
            {   int ret = slice_from_s(1, s_10); /* <-, line 83 */
                if (ret < 0) return ret;
            }
            break;
        case 6:
            {   int ret = slice_from_s(2, s_11); /* <-, line 85 */
                if (ret < 0) return ret;
            }
            break;
        case 7:
            {   int ret = slice_from_s(4, s_12); /* <-, line 87 */
                if (ret < 0) return ret;
            }
            break;
    }
...
int Xapian::InternalStemRomanian::r_combo_suffix() { /* backwardmode */
    ...
    {   int m_test1 = l - c; /* test, line 91 */
        ...
        switch(among_var) { /* among, line 93 */
            case 0: return 0;
            case 1:
                {   int ret = slice_from_s(4, s_13); /* <-, line 101 */
                    if (ret < 0) return ret;
                }
                break;
            case 2:
                {   int ret = slice_from_s(4, s_14); /* <-, line 104 */
                    if (ret < 0) return ret;
                }
                break;
            case 3:
                {   int ret = slice_from_s(2, s_15); /* <-, line 107 */
                    if (ret < 0) return ret;
                }
                break;
            case 4:
                ...
                break;
            case 5:
                {   int ret = slice_from_s(2, s_17); /* <-, line 118 */
                    if (ret < 0) return ret;
                }
                break;
            case 6:
                {   int ret = slice_from_s(2, s_18); /* <-, line 122 */
                    if (ret < 0) return ret;
                }
                break;
        }
...
int Xapian::InternalStemRomanian::r_standard_suffix() { /* backwardmode */
    ...
    switch(among_var) { /* among, line 133 */
        ...
        case 1:
            ...
            break;
        case 2:
            if (!(eq_s_b(2, s_19))) return 0; /* literal, line 152 */
            bra = c; /* ], line 152 */
            {   int ret = slice_from_s(1, s_20); /* <-, line 152 */
                if (ret < 0) return ret;
            }
            break;
        case 3:
            {   int ret = slice_from_s(3, s_21); /* <-, line 156 */
                if (ret < 0) return ret;
            }
            break;
    }
    ...
    {   int m1 = l - c; (void)m1; /* setlimit, line 164 */
        ...
        switch(among_var) { /* among, line 165 */
            ...
            case 1:
                ...
                lab1:
                    c = l - m2;
                    if (!(eq_s_b(1, s_22))) { lb = mlimit1; return 0; } /* literal, line 200 */
                }
            lab0:
