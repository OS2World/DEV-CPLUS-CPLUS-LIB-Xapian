...
int Xapian::InternalStemPorter::r_Step_1c() { /* backwardmode */
    ...
    {   int m1 = l - c; (void)m1; /* or, line 52 */
        if (!(eq_s_b(1, s_5))) goto lab1; /* literal, line 52 */
        goto lab0;
    lab1:
        c = l - m1;
        if (!(eq_s_b(1, s_6))) return 0; /* literal, line 52 */
    }
lab0:
    bra = c; /* ], line 52 */
    ...
    {   int ret = slice_from_s(1, s_7); /* <-, line 54 */
        if (ret < 0) return ret;
    }
    return 1;
}
...
int Xapian::InternalStemPorter::r_Step_2() { /* backwardmode */
    ...
    switch(among_var) { /* among, line 58 */
        case 0: return 0;
        case 1:
            {   int ret = slice_from_s(4, s_8); /* <-, line 59 */
                if (ret < 0) return ret;
            }
            break;
        case 2:
            ...
            break;
        case 3:
            {   int ret = slice_from_s(4, s_10); /* <-, line 61 */
                if (ret < 0) return ret;
            }
            break;
        case 4:
            {   int ret = slice_from_s(4, s_11); /* <-, line 62 */
                if (ret < 0) return ret;
            }
            break;
        case 5:
            {   int ret = slice_from_s(3, s_12); /* <-, line 63 */
                if (ret < 0) return ret;
            }
            break;
        case 6:
            {   int ret = slice_from_s(1, s_13); /* <-, line 64 */
                if (ret < 0) return ret;
            }
            break;
        case 7:
            {   int ret = slice_from_s(3, s_14); /* <-, line 66 */
                if (ret < 0) return ret;
            }
            break;
        case 8:
            {   int ret = slice_from_s(3, s_15); /* <-, line 68 */
                if (ret < 0) return ret;
            }
            break;
        case 9:
            {   int ret = slice_from_s(2, s_16); /* <-, line 69 */
                if (ret < 0) return ret;
            }
            break;
        case 10:
            {   int ret = slice_from_s(2, s_17); /* <-, line 71 */
                if (ret < 0) return ret;
            }
            break;
        case 11:
            {   int ret = slice_from_s(3, s_18); /* <-, line 72 */
                if (ret < 0) return ret;
            }
            break;
        case 12:
            {   int ret = slice_from_s(3, s_19); /* <-, line 74 */
                if (ret < 0) return ret;
            }
            break;
        case 13:
            {   int ret = slice_from_s(3, s_20); /* <-, line 76 */
                if (ret < 0) return ret;
            }
            break;
        case 14:
            {   int ret = slice_from_s(3, s_21); /* <-, line 77 */
                if (ret < 0) return ret;
            }
            break;
    }
...
int Xapian::InternalStemPorter::r_Step_3() { /* backwardmode */
    ...
    switch(among_var) { /* among, line 82 */
        case 0: return 0;
        case 1:
            {   int ret = slice_from_s(2, s_22); /* <-, line 83 */
                if (ret < 0) return ret;
            }
            break;
        case 2:
            {   int ret = slice_from_s(2, s_23); /* <-, line 85 */
                if (ret < 0) return ret;
            }
            break;
        case 3:
    ...
    switch(among_var) { /* among, line 92 */
        ...
        case 2:
            {   int m1 = l - c; (void)m1; /* or, line 96 */
                if (!(eq_s_b(1, s_24))) goto lab1; /* literal, line 96 */
                goto lab0;
            lab1:
                c = l - m1;
                if (!(eq_s_b(1, s_25))) return 0; /* literal, line 96 */
            }
        lab0:
...
int Xapian::InternalStemPorter::r_Step_5a() { /* backwardmode */
    ket = c; /* [, line 101 */
    if (!(eq_s_b(1, s_26))) return 0; /* literal, line 101 */
    bra = c; /* ], line 101 */
...
int Xapian::InternalStemPorter::r_Step_5b() { /* backwardmode */
    ket = c; /* [, line 107 */
    if (!(eq_s_b(1, s_27))) return 0; /* literal, line 107 */
    bra = c; /* ], line 107 */
    {   int ret = r_R2(); /* call R2, line 108 */
        if (ret == 0) return 0;
        if (ret < 0) return ret;
    }
    if (!(eq_s_b(1, s_28))) return 0; /* literal, line 108 */
...
int Xapian::InternalStemPorter::stem() { /* forwardmode */
    ...
    {   int c1 = c; /* do, line 116 */
        bra = c; /* [, line 116 */
        if (!(eq_s(1, s_29))) goto lab0; /* literal, line 116 */
        ket = c; /* ], line 116 */
        {   int ret = slice_from_s(1, s_30); /* <-, line 116 */
            if (ret < 0) return ret;
        }
    ...
    {   int c2 = c; /* do, line 117 */
        while(1) { /* repeat, line 117 */
            ...
            while(1) { /* goto, line 117 */
                ...
                bra = c; /* [, line 117 */
                if (!(eq_s(1, s_31))) goto lab3; /* literal, line 117 */
                ket = c; /* ], line 117 */
                c = c4;
                break;
            lab3:
            ...
            {   int ret = slice_from_s(1, s_32); /* <-, line 117 */
                if (ret < 0) return ret;
            }
    ...
    {   int c14 = c; /* do, line 137 */
        ...
        while(1) { /* repeat, line 137 */
            ...
            while(1) { /* goto, line 137 */
                int c16 = c;
                bra = c; /* [, line 137 */
                if (!(eq_s(1, s_33))) goto lab15; /* literal, line 137 */
                ket = c; /* ], line 137 */
                c = c16;
                break;
            lab15:
            ...
            {   int ret = slice_from_s(1, s_34); /* <-, line 137 */
                if (ret < 0) return ret;
            }
            continue;
        lab14:
